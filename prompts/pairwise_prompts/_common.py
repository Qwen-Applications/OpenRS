...
assert sep_1 in pairwise_prompt_common_template
assert sep_2 in pairwise_prompt_common_template
...
pairwise_prompt_common_template = pre_fix + sep_1 + pairwise_prompt_rubrics + sep_2 + post_fix
